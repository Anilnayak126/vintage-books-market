...
const PrivacyPolicy = () => {
  return (
    <section className="glass-page text-white">
      <div className="page-container glass-panel p-6 sm:p-8">
        <h2 className="section-title mb-6 text-center text-3xl sm:text-4xl">
          Privacy Policy
        </h2>

        <div className="prose max-w-full muted-copy">
          <p>
          ...
          <h3 className="mt-6 text-2xl font-semibold text-white">1. Information Collection</h3>
          <p>
          ...
          <h3 className="mt-6 text-2xl font-semibold text-white">2. Use of Information</h3>
          <p>
          ...
          <h3 className="mt-6 text-2xl font-semibold text-white">3. Data Security</h3>
          <p>
          ...
          <h3 className="mt-6 text-2xl font-semibold text-white">4. Sharing of Information</h3>
          <p>
          ...
          <h3 className="mt-6 text-2xl font-semibold text-white">5. Cookies</h3>
          <p>
          ...
          <h3 className="mt-6 text-2xl font-semibold text-white">6. User Rights</h3>
          <p>
          ...
          <h3 className="mt-6 text-2xl font-semibold text-white">7. Changes to Privacy Policy</h3>
          <p>
          ...
          <h3 className="mt-6 text-2xl font-semibold text-white">8. Contact Us</h3>
          <p>
