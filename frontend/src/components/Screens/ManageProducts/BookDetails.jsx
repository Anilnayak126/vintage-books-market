...
import { FaWhatsapp, FaEnvelope, FaPhone, FaCartPlus, FaArrowLeft, FaClock } from 'react-icons/fa';
...
const BookDetails = () => {
  ...
  // Local state to handle redirect and prevent unnecessary fetch calls after login
        ...
        {bookDetailsStatus === 'loading' ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <img
              ...
              onError={(e) => { e.target.src = '/fallback-image.jpg'; }} // Provide a fallback image
            />
            ...
            <div className="space-y-4">
              ...
              {/* Add to Cart Button */}
              <button className="mt-6 flex items-center w-full justify-center px-4 py-2 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600 transition duration-300 text-xl">
          ...
          <div className="p-6 bg-gradient-to-b from-gray-700 to-gray-800 rounded-lg shadow-lg mt-8">
            ...
            <div className="flex flex-col md:flex-row items-center md:space-x-6 space-y-4 md:space-y-0">
              ...
              <img
                ...
                onError={(e) => { e.target.src = '/fallback-profile.jpg'; }} // Fallback for user profile
              />
